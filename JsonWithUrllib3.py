import urllib3 #pip instlall packagename
...
response = http.request("GET", "https://dummyjson.com/products/1")
print(response.data) # Prints 200
...
# response = http.request("POST", "http://localhost:8586/employees/EmployeeCreation", fields={"id": 444,"name": "virat","salary":788000,"phonenumber": 888888,"company":"kpmg"},headers={'Content-Type': 'application/json'})
